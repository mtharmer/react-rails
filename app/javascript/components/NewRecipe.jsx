...
export default function NewRecipe() {
  ...
  const onChange = (event, setFunc) => setFunc(event.target.value);
        ...
        <div className="col-sm-12 col-lg-6 offset-lg-3">
          ...
          <form onSubmit={onSubmit}>
            <div className="form-group">
              ...
              <input type="text" name="name" id="recipeName" className="form-control" required
            ...
            <div className="form-group">
              ...
              <input type="text" name="image" id="recipeImage" className="form-control"
